...
modelo <- nnet(BuenPagador~., data = taprendizaje, size = 250, MaxNWts = 5000, rang = 0.1, 
...
**Se genera el modelo**
```{r}
modelo <- train.nnet(BuenPagador~., data = taprendizaje, size = 250, MaxNWts = 5000, rang = 0.1, 
                     decay = 5e-4, maxit = 200, trace = FALSE)
modelo
```
...
```{r}
# Importante size=250, con size=4 la predicción sería muy mala
modelo<-nnet(BuenPagador~CoefCreditoAvaluo+MontoCredito+IngresoNeto, data = taprendizaje, size = 250,

...
indices.general(MC)
# Genera el modelo kernel = "radial"
modelo <- svm(tipo~., data = taprendizaje, kernel = "radial")
modelo
# Prediccion y Matriz de Confusion
prediccion <- predict(modelo,ttesting)
MC<-table(ttesting[,5],prediccion)
...
# Genera el modelo kernel = "polynomial"
modelo <- svm(tipo~., data = taprendizaje, kernel = "polynomial")
modelo
# Prediccion y Matriz de Confusion
prediccion <- predict(modelo,ttesting)
MC<-table(ttesting[,5],prediccion)
...
# Genera el modelo kernel = "sigmoid"
modelo <- svm(tipo~., data = taprendizaje, kernel = "sigmoid")
modelo
# Prediccion y Matriz de Confusion
prediccion <- predict(modelo,ttesting)
MC<-table(ttesting[,5],prediccion)
...
# Genera el modelo kernel = "sigmoid"
modelo <- svm(tipo~p.largo+p.ancho, data = taprendizaje, kernel = "sigmoid")
modelo
# Prediccion y Matriz de Confusion
prediccion <- predict(modelo,ttesting)
MC<-table(ttesting[,5],prediccion)
...
### Usando solo 2 variables para poder graficar el diagrama de Voronoi
...
taprendizaje <- datos[-muestra,]
# Genera el modelo
modelo <- svm(BuenPagador~CoefCreditoAvaluo+MontoCuota+IngresoNeto+GradoAcademico, data=taprendizaje)
modelo
## Prediccion y Matriz de Confusión
prediccion <- predict(modelo,ttesting)
MC<-table(ttesting[,6],prediccion)
...
# Genera el modelo con kernel sigmoid
modelo <- svm(BuenPagador~CoefCreditoAvaluo+MontoCuota+IngresoNeto+GradoAcademico, data=taprendizaje,kernel="sigmoid")
modelo
## Prediccion y Matriz de Confusión
prediccion <- predict(modelo,ttesting)
MC<-table(ttesting[,6],prediccion)
